...
from abs_implementation.implementation import RealVelocity, RealPosition, RealRotate, Vector
...
class TestGetNewVelocity(unittest.TestCase):
    ...
    def setUp(self):
        angle = 30
        self.ship = RotatableShip(Vector(RealPosition(), RealVelocity()), RealRotate(angle))
